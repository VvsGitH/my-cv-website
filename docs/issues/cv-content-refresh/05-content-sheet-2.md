...
- **Progetti completi** (RUOP, Beyond Knowledge): bullet riscritti con la formula XYZ e al participio. Si tolgono i bullet generici ("Gestione del repository GitHub", "Documentazione tecnica e testing") o si fondono in un bullet specifico. N6/N7 se disponibili.
